...
<div class="alert alert-danger alert-block m-0 position-fixed bottom-0" style="width: 100%; z-index: 1000">
    <button onclick="this.parentElement.style.display = 'none'" id="alert-btn" data-dismiss="alert" class="btn position-absolute top-50 translate-middle end-0"><i class="fa-solid fa-xmark"></i></button>
